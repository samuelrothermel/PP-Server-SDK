...
document.getElementById('create-product-form').addEventListener('submit', async (e) => {
  ...
  try {
    ...
    if (response.ok) {
      ...
      showSuccess(`Product "${product.name}" created successfully! ID: ${product.id}`);
    ...
    <div class="product-card">
      ...
      <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #eee;">
        <div style="font-size: 0.85em; color: #666;">
          ...
          <code style="background: #f8f9fa; padding: 4px 8px; border-radius: 4px; display: inline-block; margin-top: 5px;">${product.id}</code>
        </div>
