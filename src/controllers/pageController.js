...
export const renderJsSdkV6Product = renderPage('js-sdk-v6-product');
export const renderJsSdkV6Cart = renderPage('js-sdk-v6-cart');
export const renderApiOnlyCheckout = renderPage('api-only-checkout');
